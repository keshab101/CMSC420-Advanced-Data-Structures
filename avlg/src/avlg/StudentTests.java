...
public class StudentTests {
    ...
    public void testCorrectRotationAfterDelete() throws InvalidBalanceException, EmptyTreeException{
        ...
        */
        ...
        assertEquals("In an AVL-1 tree where we deleted the root's singleton left child, we encountered an unexpected new root.",
                Integer.valueOf(6), tree.getRoot());
    ...
    @Test
    public void testAdvanceInsert() throws InvalidBalanceException, EmptyTreeException {
        tree = new AVLGTree<>(1);
        tree.insert(5);
        tree.insert(-5);
        tree.insert(10);
        tree.insert(-10);
        tree.insert(-8);
        assertEquals("The root should be 5 with no rotations", Integer.valueOf(5), tree.getRoot());
        assertTrue(tree.getHeight() == 2);
    }
    
    @Test
    public void testSearch() throws EmptyTreeException, InvalidBalanceException {
	      
    	  tree = new AVLGTree<Integer>(1);
	      tree.insert(8);
	      tree.insert(10);
	      tree.insert(4);
	      tree.insert(3);
	      ...
	      tree.insert(12);
          tree.delete(12);
          assertEquals(tree.search(12), null);
          tree.delete(8);
    ...
    @Test
    public void testMoreDeletions() throws InvalidBalanceException, EmptyTreeException {
        tree = new AVLGTree<Integer>(1);
        tree.insert(8);
        ...
        assertTrue(tree.getRoot() == 9);
        assertTrue(tree.getHeight() == 2);
        assertTrue(tree.getCount() == 6);
        
        tree.delete(12);
        assertTrue(tree.getRoot() == 9);
        assertTrue(tree.getHeight() == 2);
        assertTrue(tree.getCount() == 5);
        
        tree.delete(10);
        assertTrue(tree.getRoot() == 4);
        assertTrue(tree.getHeight() == 2);
    ...
    @Test
    public void testClearFunction() throws InvalidBalanceException, EmptyTreeException {
    	tree = new AVLGTree<Integer>(1);
        tree.insert(8);
        tree.delete(8);
    ...
    @Test
    public void testDeletetionsAndAVLGBalanced() throws InvalidBalanceException, EmptyTreeException {
    	tree = new AVLGTree<Integer>(2);
    	tree.insert(28);
    	tree.insert(20);
    	tree.insert(36);
    	tree.insert(7);
    	...
    	tree.insert(56);
    	assertTrue(tree.isAVLGBalanced());
    	assertTrue(tree.getCount() == 11);
    	tree.delete(28);
    	assertTrue(tree.getCount() == 10);
    	assertTrue(tree.getRoot() == 32);	
    	tree.delete(36);
    	assertTrue(tree.getRoot() == 32);
    }
